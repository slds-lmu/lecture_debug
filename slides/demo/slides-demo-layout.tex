...
\begin{frame}[allowframebreaks]{\textbackslash splitV(TCB)(TCB)}
...
\begin{frame}[allowframebreaks]{\textbackslash splitV with unequal sizes}
...
\end{frame}
\begin{frame}[allowframebreaks]{Two columns, minimal adjustments}
...
\begin{frame}{Image taking the full width by default}
...
\begin{frame}[allowframebreaks]{Images with alignment and optional attribution}
...
\begin{frame}[allowframebreaks]{Images within itemize}
...
\begin{frame}[allowframebreaks]{Images within splitVCC}
  ...
  \splitVCC{
  \image[0.5]{figure/boosting-cwb-blpool1.png}
  }{
  \image[0.7]{figure/boosting-cwb-blpool1.png}
  }
  
  \vfill
  
  \splitVCC[0.4]{
    \imageC[1][CITEKEY]{figure/boosting-cwb-blpool1.png}
    }{
    \image{figure/boosting-cwb-blpool1.png}
  }
