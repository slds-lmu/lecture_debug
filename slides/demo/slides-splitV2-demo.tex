...
% Load the improved splitV2 package
\usepackage{../../style/splitV2}
...
\begin{frame}{SplitV2 Overview}
  \splitVTT{
    \textbf{Key Features}
    \begin{itemize}
      \item Works in all contexts including within lists
      \item Maintains original API for backward compatibility
    ...
    \begin{itemize}
      ...
      \item Special commands for common patterns
    \end{itemize}
  }
  ...
  \splitVCC{
    ...
    \begin{itemize}
      \item Uses lrbox for maximum compatibility
