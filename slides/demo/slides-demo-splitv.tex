...
\begin{framev}[fs=footnotesize]{Integration with Frame2 Environment}
  Using splitV inside the framev environment with small font.
  
  \splitVCC{
  \textbf{Left Column}
  \begin{itemize}
    \item The entire content has smaller font
    \item Due to the framev environment
